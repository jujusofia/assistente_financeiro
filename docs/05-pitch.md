...
Alerta sobre riscos de comprometimento da renda.
Responde apenas com base em informações oficiais (INSS, bancos, legislação).
Admite quando não sabe e redireciona para atendimento humano.
Assim, o cliente toma decisões mais conscientes e seguras.
